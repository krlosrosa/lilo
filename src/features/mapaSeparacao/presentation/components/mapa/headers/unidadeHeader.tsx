...
export const UnidadeHeader: React.FC<UnidadeHeaderProps> = ({ header, caminho, type, index }) => {
  ...
  return (
    <div className="bg-gradient-to-r from-purple-50 to-violet-50 border border-purple-200 rounded p-1.5 print:bg-white print:border-gray-400">
      <div className="flex justify-between items-center gap-1">
        {/* Informações principais */}
        <div className="flex flex-col gap-y-2 text-xs w-full">
          <div className="flex text-base items-center justify-between bg-gradient-to-r from-purple-50 to-violet-50 rounded-md border-l-4 border-purple-500 px-4 py-3">
            <div className="flex items-center gap-6">
              <div className="flex items-center gap-2 text-purple-700">
                <Package2 className="w-5 h-5" />
                <span className="text-lg font-bold">UNIDADES - {transporte?.toUpperCase()}</span>
              </div>
          ...
          {/* Resumo de quantidades - Destaque especial para unidades */}
