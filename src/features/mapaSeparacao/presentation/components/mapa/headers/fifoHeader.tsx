...
export const FifoHeader: React.FC<FifoHeaderProps> = ({ header, caminho, type, index }) => {
  ...
  return (
    <div className="bg-gradient-to-r from-orange-50 to-yellow-50 border border-orange-200 rounded p-1.5 print:bg-white print:border-gray-400">
      <div className="flex justify-between items-center gap-1">
        {/* Informações principais */}
        <div className="flex flex-col gap-y-2 text-xs w-full">
          <div className="flex text-base items-center justify-between bg-gradient-to-r from-orange-50 to-yellow-50 rounded-md border-l-4 border-orange-500 px-4 py-3">
            <div className="flex items-center gap-6">
              <div className="flex items-center gap-2 text-orange-700">
                <Clock className="w-5 h-5" />
                <span className="text-lg font-bold">FIFO - {transporte?.toUpperCase()}</span>
              </div>
          ...
          <div className="flex text-neutral-900 gap-4 font-semibold text-[10px]">
            <div className="flex items-center gap-1">
              <Clock size={12} />
              <p>Sequência FIFO: {header?.sequencia}</p>
            </div>
            <div className="flex items-center gap-1">
              <Truck size={12} />
